...
"""Test running quicksilver-daemon with -reindex from a read-only blockstore
...
class BlockstoreReindexTest(QuicksilverTestFramework):
    ...
    def reindex_readonly(self):
        ...
        if undo_immutable:
            ...
            with self.nodes[0].assert_debug_log(["reindexed ok=1"], timeout=60):
