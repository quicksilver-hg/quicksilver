...
class P2PLeakTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        ...
        with self.nodes[0].assert_debug_log(["using obsolete version 70015"]):
            p2p_old_peer.send_message(self.create_old_version(70015))
