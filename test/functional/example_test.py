...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QuicksilverTestFramework
    pass


class ExampleTest(QuicksilverTestFramework):
    # Each functional test is a subclass of the QuicksilverTestFramework class.
    ...
    # This test uses generate which requires vault to be compiled
    ...
    def custom_method(self):
        ...
        QuicksilverTestFramework class so other tests can use it."""
