...
if uploadtarget has been reached.
* Verify that relaypool requests lead to a disconnect if uploadtarget has been reached.
...
class MaxUploadTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        ...
        mine_large_block(self, self.vault, self.nodes[0])
