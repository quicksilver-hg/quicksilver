...
class ImportPrunedFundsTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[1].createvault('wwatch', disable_private_keys=True)
        wwatch = self.nodes[1].get_vault_rpc('wwatch')
        ...
        w1 = self.nodes[1].get_vault_rpc(self.default_vault_name)
        ...
        # Remove transactions
        assert_raises_rpc_error(-4, f'Transaction {txnid1} does not belong to this vault', w1.removeprunedfunds, txnid1)
