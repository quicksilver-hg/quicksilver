...
class P2PLeakTxTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        ...
        self.minivault = MiniVault(self.gen_node)
        self.generate(self.minivault, COINBASE_MATURITY + 2)
    ...
    def test_tx_in_block(self):
        ...
        wtxid = self.minivault.send_self_transfer(from_node=self.gen_node)["wtxid"]
    ...
    def test_notfound_on_unannounced_tx(self):
        ...
        for i in range(MAX_REPEATS):
            ...
            txid = self.minivault.send_self_transfer(from_node=self.gen_node)["wtxid"]
