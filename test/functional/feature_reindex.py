...
"""Test running quicksilver-daemon with -reindex and -reindex-chainstate options.
...
class ReindexTest(QuicksilverTestFramework):
    ...
    def out_of_order(self):
        ...
        with open(blk0, 'r+b') as bf:
            ...
            # by searching for the sandbox marker bytes (see pchMessageStart).
            def find_block(b, start):
                return b.find(MAGIC_BYTES["sandbox"], start)+4
