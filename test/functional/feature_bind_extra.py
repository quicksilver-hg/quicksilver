...
"""
Test starting quicksilver-daemon with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that quicksilver-daemon has bound on "::1" (for RPC) and "::" (for P2P).
