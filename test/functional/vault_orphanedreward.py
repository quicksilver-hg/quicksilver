...
"""Test orphaned block rewards in the vault."""

from test_framework.test_framework import QuicksilverTestFramework
from test_framework.util import assert_equal

class OrphanedBlockRewardTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        ...
        self.generate(self.nodes[0], 150)
        assert_equal(self.nodes[1].getbalance(), 10 + 1)
        ...
        # from the vault can still be spent.
        ...
        assert_equal(self.nodes[1].getbalances()["mine"], {
          ...
          "untrusted_pending": 0,
          "immature": 0,
          # This node funds no agent, so nothing is ever locked out of coin selection.
          "delegated": 0,
        })
        ...
        self.nodes[1].unloadvault(self.default_vault_name)
        self.nodes[1].loadvault(self.default_vault_name)
        assert_equal(self.nodes[1].gettransaction(txid)["details"][0]["abandoned"], True)
