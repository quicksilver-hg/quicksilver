...
ONION_ADDR = "pg6mmjiyjmcrsslvykfwnntlaru7p5svn6y2ymmju6nubxndf4pscryd.onion:9555"


class AnchorsTest(QuicksilverTestFramework):
    ...
    def run_test(self):
        ...
        with self.nodes[0].assert_debug_log(["loaded anchors=0"]):
