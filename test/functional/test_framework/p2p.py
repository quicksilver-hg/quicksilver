...
"""Test objects for interacting with a quicksilverd node over the p2p protocol.

The P2PInterface objects interact with the quicksilverd nodes under test using the
