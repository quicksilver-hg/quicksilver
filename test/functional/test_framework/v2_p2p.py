...
SHORTID = {
    ...
    3: b"blocktxn",
    4: b"cmpctblock",
    # 5 unused so later BIP324 short ids stay put
    # 6 ("filteradd"), 7 ("filterclear"), 8 ("filterload") unused: BIP37 not spoken
    9: b"getblocks",
    10: b"getblocktxn",
    11: b"getdata",
    12: b"getheaders",
    13: b"headers",
    14: b"inv",
    # 15 unused: the BIP35 pool-request message is not spoken
    # 16 ("merkleblock") unused: BIP37 not spoken
    17: b"notfound",
    18: b"ping",
    19: b"pong",
    20: b"sendcmpct",
...
class EncryptedP2PState:
    ...
    Args:
        ...
        net (string): chain used (sandbox, publictest, etc.)
    ...
    def initialize_v2_transport(self, ecdh_secret):
        ...
        peer = {}
        salt = b'quicksilver_v2_shared_secret' + MAGIC_BYTES[self.net]
