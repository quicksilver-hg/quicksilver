...
class TestFrameworkScript(unittest.TestCase):
    def test_segwit_encode_decode(self):
        def test_python_bech32(addr):
            ...
            self.assertEqual(hrp, "shg")
            (witver, witprog) = decode_segwit_address(hrp, addr)
            self.assertEqual(encode_segwit_address(hrp, witver, witprog), addr)

        # P2WPKH
        test_python_bech32('shg1qtmp74ayg7p24uslctssvjm06q5phz4yrq6vjet')
        # P2WSH
        test_python_bech32('shg1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq55gtdc')
        test_python_bech32('shg1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsq4tf2w7')
        # P2TR
        test_python_bech32('shg1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqsuyfjlh')
