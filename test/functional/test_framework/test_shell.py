...
class TestShell:
    """Wrapper Class for QuicksilverTestFramework.

    The TestShell class extends the QuicksilverTestFramework
    ...
    class __TestShell(QuicksilverTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QuicksilverTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # QuicksilverTestFramework instances are supposed to be constructed with the path
