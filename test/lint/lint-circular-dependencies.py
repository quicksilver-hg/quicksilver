...
EXPECTED_CIRCULAR_DEPENDENCIES = (
    ...
    "qt/addresstablemodel -> qt/vaultmodel -> qt/addresstablemodel",
    "qt/recentrequeststablemodel -> qt/vaultmodel -> qt/recentrequeststablemodel",
    "qt/sendcoinsdialog -> qt/vaultmodel -> qt/sendcoinsdialog",
    "qt/transactiontablemodel -> qt/vaultmodel -> qt/transactiontablemodel",
    "vault/vault -> vault/vaultdb -> vault/vault",
