...
This guide describes how to build quicksilverd, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build vault functionality to run quicksilverd or the GUI.
