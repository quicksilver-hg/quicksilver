...
#ifndef QUICKSILVER_ZMQ_ZMQPUBLISHNOTIFIER_H
#define QUICKSILVER_ZMQ_ZMQPUBLISHNOTIFIER_H
...
public:
    ...
    bool NotifyTransactionAcceptance(const CTransaction &transaction, uint64_t relaypool_sequence) override;
    bool NotifyTransactionRemoval(const CTransaction &transaction, uint64_t relaypool_sequence) override;
};

#endif // QUICKSILVER_ZMQ_ZMQPUBLISHNOTIFIER_H
