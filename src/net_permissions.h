...
#ifndef QUICKSILVER_NET_PERMISSIONS_H
#define QUICKSILVER_NET_PERMISSIONS_H
...
enum class NetPermissionFlags : uint32_t {
    ...
    Relay = (1U << 3),
    // Always relay transactions from this peer, even if already in relaypool
...
#endif // QUICKSILVER_NET_PERMISSIONS_H
