...
#ifndef QUICKSILVER_UTIL_EPOCHGUARD_H
#define QUICKSILVER_UTIL_EPOCHGUARD_H
 ...
 *     In many algorithms we can replace std::set with an internal relaypool
 ...
 * Generally speaking, however, the remaining use of std::set for relaypool
...
#endif // QUICKSILVER_UTIL_EPOCHGUARD_H
