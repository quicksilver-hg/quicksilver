...
#ifndef QUICKSILVER_INDEX_COINSTATSINDEX_H
#define QUICKSILVER_INDEX_COINSTATSINDEX_H
...
private:
    ...
    CAmount m_total_mint_allowance{0};
...
#endif // QUICKSILVER_INDEX_COINSTATSINDEX_H
