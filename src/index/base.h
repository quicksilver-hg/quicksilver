...
#ifndef QUICKSILVER_INDEX_BASE_H
#define QUICKSILVER_INDEX_BASE_H
 ...
 *
 * Indexes are built sequentially against the single fully-validating
 * chainstate.
 */
...
#endif // QUICKSILVER_INDEX_BASE_H
