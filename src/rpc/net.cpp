...
static RPCHelpMan addnode()
{
    return RPCHelpMan{"addnode",
                ...
                "full nodes that can serve witness data as other outbound peers are (though such peers will not be synced from).\n" +
...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{"addconnection",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    if (Params().GetChainType() != ChainType::SANDBOX) {
        throw std::runtime_error("addconnection is for regression testing (-sandbox mode) only.");
    }
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The Quicksilver server IP and port we're connected to"},
