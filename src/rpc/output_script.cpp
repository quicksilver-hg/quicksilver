...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Quicksilver address to validate"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::BOOL, "isvalid", "If the address is valid or not"},
                {RPCResult::Type::STR, "address", /*optional=*/true, "The Quicksilver address validated"},
                {RPCResult::Type::STR_HEX, "output_script", /*optional=*/true, "The hex-encoded output script generated by the address"},
...
static RPCHelpMan createmultisig()
{
    return RPCHelpMan{"createmultisig",
        ...
        "It returns a json object with the address and redeem_script.\n",
        {
            ...
            {"address_type", RPCArg::Type::STR, RPCArg::Default{"bech32"}, "The address type to use. Options are \"base58\" and \"bech32\"."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::STR, "address", "The value of the new multisig address."},
                {RPCResult::Type::STR_HEX, "redeem_script", "The string value of the hex-encoded redemption script."},
...
{
    const std::string EXAMPLE_DESCRIPTOR = "wpkh([d34db33f/84h/9556h/0h]0279be667ef9dcbbac55a06295Ce870b07029Bfcdb2dce28d959f2815b16f81798)";
...
{
    const std::string EXAMPLE_DESCRIPTOR = "wpkh([d34db33f/84h/9556h/0h]qpub3wUBVhnZq5yiYohGtmWwsZnWWEZnLfwy2fAECN8WBL5KXFRokRHyqiBt9TQug6UZpSPqYNBp2MvqLn7nHMzxDw49NcpUkudZ5uMiSigN9MT/0/*)#yvgzdg90";

    return RPCHelpMan{"deriveaddresses",
        {"\nDerives one or more addresses corresponding to an output descriptor.\n"
         "Examples of output descriptors are:\n"
         "    pkh(<pubkey>)                                     P2PKH outputs for the given pubkey\n"
         "    wpkh(<pubkey>)                                    P2WPKH outputs for the given pubkey\n"
        ...
        RPCExamples{
            "First three bech32 receive addresses\n" +
