...
#ifndef QUICKSILVER_RPC_RAWTRANSACTION_UTIL_H
#define QUICKSILVER_RPC_RAWTRANSACTION_UTIL_H
...
/**
  ...
  * @param  coins         Map of unspent outputs - coins in relaypool and current chain UTXO set, may be extended by previous txns outputs after call
  */
...
#endif // QUICKSILVER_RPC_RAWTRANSACTION_UTIL_H
