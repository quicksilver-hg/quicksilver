...
//
// It is part of the libquicksilverkernel project.
...
int main(int argc, char* argv[])
{
    ...
    for (std::string line; std::getline(std::cin, line);) {
        ...
        // The block is validated exactly as it was read: nothing fills in a missing
        // coinbase witness nonce, because doing so would change the weight that
        // nCongestion is checked against. See the note in rpc/mining.cpp.
