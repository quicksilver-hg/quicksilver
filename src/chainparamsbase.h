...
#ifndef QUICKSILVER_CHAINPARAMSBASE_H
#define QUICKSILVER_CHAINPARAMSBASE_H
...
#define LIST_CHAIN_NAMES "main, publictest, sandbox"

#endif // QUICKSILVER_CHAINPARAMSBASE_H
