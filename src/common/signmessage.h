...
#ifndef QUICKSILVER_COMMON_SIGNMESSAGE_H
#define QUICKSILVER_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's Quicksilver address, it must refer to a public key.
...
#endif // QUICKSILVER_COMMON_SIGNMESSAGE_H
