...
#ifndef QUICKSILVER_COMMON_ARGS_H
#define QUICKSILVER_COMMON_ARGS_H
...
extern const char * const QUICKSILVER_CONF_FILENAME;
extern const char * const QUICKSILVER_SETTINGS_FILENAME;
...
public:
    ...
    enum Flags : uint32_t {
         ...
         * mainnet were used while running on sandbox/publictest (or vice-versa).
         * Setting them as NETWORK_ONLY ensures that sharing a config file
         * between mainnet and sandbox/publictest won't cause problems due to these
...
protected:
 ...
 public:
     ...
     *
     * @param arg Argument to get a path from (e.g., "-datadir", "-blocksdir" or "-vaultdir")
...
private:
    ...
    /**
     * Return -sandbox/-publictest/-chain= setting as a ChainType enum if a
...
#endif // QUICKSILVER_COMMON_ARGS_H
