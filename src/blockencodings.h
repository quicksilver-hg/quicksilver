...
#ifndef QUICKSILVER_BLOCKENCODINGS_H
#define QUICKSILVER_BLOCKENCODINGS_H
...
protected:
    ...
    size_t prefilled_count = 0, relaypool_count = 0, extra_count = 0;
...
public:
    ...
    explicit PartiallyDownloadedBlock(CTxRelayPool* poolIn) : pool(poolIn) {}
...
#endif // QUICKSILVER_BLOCKENCODINGS_H
