...
#ifndef QUICKSILVER_VAULT_COINCONTROL_H
#define QUICKSILVER_VAULT_COINCONTROL_H
...
public:
    ...
    //! If true, the selection process can add extra unselected inputs from the vault
...
#endif // QUICKSILVER_VAULT_COINCONTROL_H
