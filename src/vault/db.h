...
#ifndef QUICKSILVER_VAULT_DB_H
#define QUICKSILVER_VAULT_DB_H
...
/** RAII class that provides access to a VaultDatabase */
class DatabaseBatch
{
private:
...
public:
    ...
    VaultDatabase() : nUpdateCounter(0) {}
    virtual ~VaultDatabase() = default;
     ...
     */
    virtual void Close() = 0;
    /* flush the vault passively (TRY_LOCK)
...
struct DatabaseOptions {
    ...
    bool read_only = false;         //!< Open without write access or an exclusive lock.
};
