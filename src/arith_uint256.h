...
#ifndef QUICKSILVER_ARITH_UINT256_H
#define QUICKSILVER_ARITH_UINT256_H
...
public:
     ...
     *
     * Quicksilver only uses this "compact" format for encoding difficulty
...
#endif // QUICKSILVER_ARITH_UINT256_H
