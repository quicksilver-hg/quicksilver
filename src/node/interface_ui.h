...
#ifndef QUICKSILVER_NODE_INTERFACE_UI_H
#define QUICKSILVER_NODE_INTERFACE_UI_H
...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...)                                  \
    ...
    /** Vault loader created. */
    ADD_SIGNALS_DECL_WRAPPER(InitVault, void, );
...
#endif // QUICKSILVER_NODE_INTERFACE_UI_H
