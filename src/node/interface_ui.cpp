...
struct UISignals {
    ...
    boost::signals2::signal<CClientUIInterface::InitVaultSig> InitVault;
...
ADD_SIGNALS_IMPL_WRAPPER(InitVault);
...
void CClientUIInterface::InitVault() { return g_ui_signals.InitVault(); }
