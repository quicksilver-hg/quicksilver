...
#ifndef QUICKSILVER_NODE_TXDOWNLOADMAN_IMPL_H
#define QUICKSILVER_NODE_TXDOWNLOADMAN_IMPL_H
...
public:
    ...
    /**
     * Filter for transactions that were recently rejected by the relaypool.
    ...
    /**
     * Filter for:
     * (1) wtxids of transactions that were recently rejected by the relaypool but are
     ...
     * have larger relaypools and thus accept transactions carrying less work than we require.
     *
...
#endif // QUICKSILVER_NODE_TXDOWNLOADMAN_IMPL_H
