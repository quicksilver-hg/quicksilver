...
#ifndef QUICKSILVER_NODE_BLOCKSTORAGE_H
#define QUICKSILVER_NODE_BLOCKSTORAGE_H
...
private:
    ...
    [[nodiscard]] bool FlushChainstateBlockFile();
    ...
    int MaxBlockfileNum() const EXCLUSIVE_LOCKS_REQUIRED(cs_LastBlockFile)
    {
        ...
        return m_blockfile_cursor.value_or(empty_cursor).file_num;
    }
...
#endif // QUICKSILVER_NODE_BLOCKSTORAGE_H
