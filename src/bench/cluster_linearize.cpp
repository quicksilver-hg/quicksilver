 ...
 *  the number of ancestor set workrate updates. The best ancestor set is always the topmost
 ...
 *  increasing workrates). These graphs are pessimal for the LIMO step in Linearize, because
...
// The following example clusters were constructed by replaying historical relaypool activity, and
