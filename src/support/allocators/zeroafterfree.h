...
#ifndef QUICKSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define QUICKSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // QUICKSILVER_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
