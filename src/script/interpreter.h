...
#ifndef QUICKSILVER_SCRIPT_INTERPRETER_H
#define QUICKSILVER_SCRIPT_INTERPRETER_H
...
{
    BASE = 0,        //!< Bare scripts and ordinary P2SH redeem scripts
    WITNESS_V0 = 1,  //!< Witness v0 (P2WPKH and P2WSH); see BIP 141
    TAPROOT = 2,     //!< Native witness v1 with 32-byte program, key path spending; see BIP 341
    TAPSCRIPT = 3,   //!< Native witness v1 with 32-byte program, script path spending, leaf version 0xc0; see BIP 342
};
...
#endif // QUICKSILVER_SCRIPT_INTERPRETER_H
