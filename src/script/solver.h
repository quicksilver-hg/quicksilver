...
// The Solver functions are used by policy and the vault, but not consensus.

#ifndef QUICKSILVER_SCRIPT_SOLVER_H
#define QUICKSILVER_SCRIPT_SOLVER_H
...
#endif // QUICKSILVER_SCRIPT_SOLVER_H
