...
#ifndef QUICKSILVER_KERNEL_NOTIFICATIONS_INTERFACE_H
#define QUICKSILVER_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // QUICKSILVER_KERNEL_NOTIFICATIONS_INTERFACE_H
