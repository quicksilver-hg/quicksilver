...
#ifndef QUICKSILVER_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define QUICKSILVER_KERNEL_DISCONNECTED_TRANSACTIONS_H
 ...
 * to the relaypool, so that anything not re-confirmed in the new chain is
 ...
 * of the list. After trimming, transactions can be re-added to the relaypool from the back of the
...
#endif // QUICKSILVER_KERNEL_DISCONNECTED_TRANSACTIONS_H
