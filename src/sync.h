...
#ifndef QUICKSILVER_SYNC_H
#define QUICKSILVER_SYNC_H
...
private:
    ...
    void Enter(const char* pszName, const char* pszFile, int nLine)
    {
        ...
        LOG_TIME_MICROS_WITH_CATEGORY(strprintf("lock contention %s, %s:%d", pszName, pszFile, nLine), HgLog::LOCK);
#endif
        Base::lock();
    }
