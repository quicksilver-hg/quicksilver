...
#ifndef QUICKSILVER_NETADDRESS_H
#define QUICKSILVER_NETADDRESS_H
...
/// Used when (un)serializing addresses in ADDRv1 format (pre-BIP155).
/// The prefix comes from 0xFD + SHA256("quicksilver")[0:5].
/// Such dummy IPv6 addresses are guaranteed to not be publicly routable as they
/// fall under RFC4193's fc00::/7 subnet allocated to unique-local addresses.
static const std::array<uint8_t, 6> INTERNAL_IN_IPV6_PREFIX{
    0xFD, 0x58, 0x5D, 0x14, 0xAC, 0x23 // 0xFD + sha256("quicksilver")[0:5].
};
...
public:
     ...
     * TODO: consider adding IsCJDNS() here when more peers adopt CJDNS.
     */
...
#endif // QUICKSILVER_NETADDRESS_H
