...
#ifndef QUICKSILVER_POLICY_POLICY_H
#define QUICKSILVER_POLICY_POLICY_H
...
/** Default for -limitancestorcount, max number of in-relaypool ancestors */
static constexpr unsigned int DEFAULT_ANCESTOR_LIMIT{25};
/** Default for -limitancestorsize, maximum kilobytes of tx + all in-relaypool ancestors */
static constexpr unsigned int DEFAULT_ANCESTOR_SIZE_LIMIT_KVB{101};
/** Default for -limitdescendantcount, max number of in-relaypool descendants */
static constexpr unsigned int DEFAULT_DESCENDANT_LIMIT{25};
/** Default for -limitdescendantsize, maximum kilobytes of in-relaypool descendants */
...
// allowing the new transaction version in the vault/RPC.
...
#endif // QUICKSILVER_POLICY_POLICY_H
