...
#ifndef QUICKSILVER_POLICY_PACKAGES_H
#define QUICKSILVER_POLICY_PACKAGES_H
...
// If a package is to be evaluated, it must be at least as large as the relaypool's ancestor/descendant limits,
...
// of the child), package limits are ultimately bounded by relaypool package limits. Ensure that the
...
enum class PackageValidationResult {
    ...
    PCKG_RELAYPOOL_ERROR,           //!< RelayPool logic error.
};
...
#endif // QUICKSILVER_POLICY_PACKAGES_H
