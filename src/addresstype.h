...
#ifndef QUICKSILVER_ADDRESSTYPE_H
#define QUICKSILVER_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a Quicksilver address
 */
...
#endif // QUICKSILVER_ADDRESSTYPE_H
