...
#ifndef QUICKSILVER_NET_H
#define QUICKSILVER_NET_H
...
public:
     ...
     * was accepted into our relaypool. Used as an inbound peer eviction criterium
...
public:
    ...
    struct Options
    {
        ...
        bool m_implicit_whitelist_relay = true;
    };
    ...
    void Init(const Options& connOptions) EXCLUSIVE_LOCKS_REQUIRED(!m_added_nodes_mutex, !m_total_bytes_sent_mutex)
    {
        ...
        m_implicit_whitelist_relay = connOptions.m_implicit_whitelist_relay;
    }
...
private:
    ...
    /** Add 'relay' to implicit whitelist permissions unless blocksonly is active. */
    bool m_implicit_whitelist_relay;
