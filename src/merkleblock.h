...
#ifndef QUICKSILVER_MERKLEBLOCK_H
#define QUICKSILVER_MERKLEBLOCK_H
...
/**
 * A block header paired with a merkle proof for a chosen subset of the block's
 * transactions. Serves the `gettxoutproof` / `verifytxoutproof` RPCs.
 *
...
#endif // QUICKSILVER_MERKLEBLOCK_H
