...
void univalue_readwrite()
{
    ...
    // Address-like strings should fail parsing
    BOOST_CHECK(!v.read("Sh7NPWrkYhreRDZh1PpAjJoBJrY2qNNEV2"));
    BOOST_CHECK(!v.read("hg1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl"));
