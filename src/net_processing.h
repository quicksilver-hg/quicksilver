...
#ifndef QUICKSILVER_NET_PROCESSING_H
#define QUICKSILVER_NET_PROCESSING_H
...
/** Default number of non-relaypool transactions to keep around for block reconstruction. Includes
...
public:
    struct Options {
        ...
        //! Number of non-relaypool transactions to keep around for block reconstruction. Includes
        //! orphan, replaced, and rejected transactions.
...
#endif // QUICKSILVER_NET_PROCESSING_H
