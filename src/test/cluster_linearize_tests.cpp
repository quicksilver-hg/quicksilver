 ...
 *  a hole. */
constexpr std::pair<WorkFrac, TestBitSet> HOLE{WorkFrac{0, 0x3FFFFF}, {}};

template<typename SetType>
void TestDepGraphSerialization(const std::vector<std::pair<WorkFrac, SetType>>& cluster, const std::string& hexenc)
{
...
BOOST_AUTO_TEST_CASE(depgraph_ser_tests)
{
    ...
    // Transactions: A(work=42,size=11), B(work=-13,size=7), B depends on A.
    TestDepGraphSerialization<TestBitSet>(
        {{{42, 11}, {}}, {{-13, 7}, {0}}},
        "0b" /* A size */
        "54" /* A work */
