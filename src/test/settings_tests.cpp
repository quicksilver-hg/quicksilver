...
BOOST_FIXTURE_TEST_CASE(Merge, MergeTestingSetup)
{
    ...
    ForEachMergeSetup([&](const ActionList& arg_actions, const ActionList& conf_actions, bool force_set,
        ...
        const std::string& name = ignore_default_section_config ? "vault" : "server";
    ...
    //
    //   SETTINGS_MERGE_TEST_OUT=results.txt ./test_quicksilver --run_test=settings_tests/Merge
    //
    ...
    BOOST_CHECK_EQUAL(out_sha_hex, "8dbeca4e407134c959e219467abef66a22f4283f88f845b31bbd527ee958b96d");
}
