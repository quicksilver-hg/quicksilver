...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Quicksilver uses 80 byte header hashes, we want to have one example for that.",
               "6d22e7a600efaf70bb78b20733569a6f86eb3a5a094e51c66002eb157bdeecd1");
