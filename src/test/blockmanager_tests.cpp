...
BOOST_AUTO_TEST_CASE(blockmanager_flush_block_file)
{
    ...
    // They are 252 bytes header (84-byte pre-pow, incl. nCongestion, + 168 for the
    // Quicksilver Cuckatoo nCycle) + 1 byte 0x00 for vtx length
    constexpr int TEST_BLOCK_SIZE{253};
