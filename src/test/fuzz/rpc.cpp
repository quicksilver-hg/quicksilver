...
const std::vector<std::string> RPC_COMMANDS_NOT_SAFE_FOR_FUZZING{
    ...
    "importrelaypool", // avoid reading from disk
    "loadvault",   // avoid reading from disk
    "saverelaypool",           // disabled as a precautionary measure: may take a file path argument in the future
...
const std::vector<std::string> RPC_COMMANDS_SAFE_FOR_FUZZING{
    ...
    "getindexinfo",
    "getmemoryinfo",
    "getrelaypoolancestors",
    "getrelaypooldescendants",
    "getrelaypoolentry",
    "getrelaypoolinfo",
    "getmininginfo",
    "getnettotals",
