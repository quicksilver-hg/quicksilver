...
#ifndef QUICKSILVER_QT_SENDCOINSENTRY_H
#define QUICKSILVER_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the transfer dialog.
 */
...
#endif // QUICKSILVER_QT_SENDCOINSENTRY_H
