...
#ifndef QUICKSILVER_QT_PAYMENTSERVER_H
#define QUICKSILVER_QT_PAYMENTSERVER_H
...
// but the main window (and the Transfer tab) is not.
//
// So, the strategy is:
//
...
extern const QString QUICKSILVER_IPC_PREFIX;
...
#endif // QUICKSILVER_QT_PAYMENTSERVER_H
