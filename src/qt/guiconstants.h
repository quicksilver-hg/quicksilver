...
#ifndef QUICKSILVER_QT_GUICONSTANTS_H
#define QUICKSILVER_QT_GUICONSTANTS_H
...
/* Quicksilver GUI -- Size of icons in status bar */
...
#endif // QUICKSILVER_QT_GUICONSTANTS_H
