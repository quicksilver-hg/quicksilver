...
void EditAddressDialog::accept()
{
    ...
    if(!saveCurrentRow())
    {
        ...
        case AddressTableModel::INVALID_ADDRESS: {
            auto* box = new QMessageBox(QMessageBox::Warning, windowTitle(),
                tr("The entered address \"%1\" is not a valid Quicksilver address.").arg(ui->addressEdit->text()),
                QMessageBox::Ok, this);
            box->setObjectName(QStringLiteral("editAddressInvalid"));
        ...
        case AddressTableModel::DUPLICATE_ADDRESS: {
            auto* box = new QMessageBox(QMessageBox::Warning, windowTitle(),
                ...
                QMessageBox::Ok, this);
            box->setObjectName(QStringLiteral("editAddressDuplicate"));
            GUIUtil::ShowModalDialogAsynchronously(box);
            break;
        }
        case AddressTableModel::VAULT_UNLOCK_FAILURE: {
            auto* box = new QMessageBox(QMessageBox::Critical, windowTitle(),
                tr("Could not unlock vault."),
                QMessageBox::Ok, this);
            box->setObjectName(QStringLiteral("editAddressUnlockFailed"));
            GUIUtil::ShowModalDialogAsynchronously(box);
            break;
        }
        case AddressTableModel::KEY_GENERATION_FAILURE: {
            auto* box = new QMessageBox(QMessageBox::Critical, windowTitle(),
                ...
                QMessageBox::Ok, this);
            box->setObjectName(QStringLiteral("editAddressKeyGenerationFailed"));
            GUIUtil::ShowModalDialogAsynchronously(box);
            break;
        }
...
QString EditAddressDialog::getDuplicateAddressWarning() const
{
    ...
    if (existing_purpose == vault::AddressPurpose::RECEIVE &&
