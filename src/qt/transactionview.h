...
#ifndef QUICKSILVER_QT_TRANSACTIONVIEW_H
#define QUICKSILVER_QT_TRANSACTIONVIEW_H
...
/** Widget showing the transaction list for a vault, including a filter row.
...
#endif // QUICKSILVER_QT_TRANSACTIONVIEW_H
