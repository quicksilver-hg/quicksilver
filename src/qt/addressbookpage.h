...
#ifndef QUICKSILVER_QT_ADDRESSBOOKPAGE_H
#define QUICKSILVER_QT_ADDRESSBOOKPAGE_H
...
private:
    ...
    void updateWindowsTitleWithVaultName();
...
#endif // QUICKSILVER_QT_ADDRESSBOOKPAGE_H
