...
static const struct {
    ...
    {ChainType::PUBLIC_TEST, QAPP_APP_NAME_PUBLIC_TEST, 70, 30},
    {ChainType::SANDBOX, QAPP_APP_NAME_SANDBOX, 160, 30},
};
...
{
    // load pixmap
    QPixmap pixmap(":/icons/quicksilver");
    ...
    if(iconColorHueShift != 0 && iconColorSaturationReduction != 0)
    {
        ...
        for(int y=0;y<img.height();y++)
        {
            ...
            for(int x=0;x<img.width();x++)
            {
                ...
                // 70° should end up with the public-test green
                h+=iconColorHueShift;
