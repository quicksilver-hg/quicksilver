...
#ifndef QUICKSILVER_QT_RECENTREQUESTSTABLEMODEL_H
#define QUICKSILVER_QT_RECENTREQUESTSTABLEMODEL_H
...
/** Model for list of recently generated payment requests / quicksilver: URIs.
 * Part of vault model.
 */
...
public:
    explicit RecentRequestsTableModel(VaultModel *parent);
...
#endif // QUICKSILVER_QT_RECENTREQUESTSTABLEMODEL_H
