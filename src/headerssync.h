...
#ifndef QUICKSILVER_HEADERSSYNC_H
#define QUICKSILVER_HEADERSSYNC_H
 ...
 *
 * The Quicksilver protocol does not offer an easy way to determine the work on a
...
#endif // QUICKSILVER_HEADERSSYNC_H
