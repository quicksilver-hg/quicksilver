...
# Extract options
function __fish_quicksilver_tx_get_options
...
# Extract commands
function __fish_quicksilver_tx_get_commands
...
# Add options
complete \
    --command quicksilver-tx \
    --condition "not __fish_quicksilver_seen_cmd (__fish_quicksilver_tx_get_commands --commandsonly)" \
    --arguments "(__fish_quicksilver_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command quicksilver-tx \
    --arguments "(__fish_quicksilver_tx_get_commands)" \
    --no-files
