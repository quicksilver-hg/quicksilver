# Linearize
Construct a linear, no-fork, best version of the Quicksilver blockchain.
...
* `netmagic`: Network magic number. (Default: the Quicksilver mainnet magic
`48475153`. Set this explicitly when linearizing publictest or sandbox — see
`example-linearize.cfg` for each network's value.)
