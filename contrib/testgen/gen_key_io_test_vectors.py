...
PUBKEY_ADDRESS_SANDBOX = 63
SCRIPT_ADDRESS_SANDBOX = 125
PRIVKEY = 166
PRIVKEY_TEST = 149
PRIVKEY_SANDBOX = 170
...
templates = [
  ...
  ((PUBKEY_ADDRESS_TEST,),    20, (),   (False, 'publictest', None, None), pubkey_prefix, pubkey_suffix),
  ((SCRIPT_ADDRESS_TEST,),    20, (),   (False, 'publictest', None, None), script_prefix, script_suffix),
  ((PUBKEY_ADDRESS_SANDBOX,), 20, (),   (False, 'sandbox', None,  None), pubkey_prefix, pubkey_suffix),
  ((SCRIPT_ADDRESS_SANDBOX,), 20, (),   (False, 'sandbox', None,  None), script_prefix, script_suffix),
  ((PRIVKEY,),                32, (),   (True,  'main',    False, None), (),            ()),
  ((PRIVKEY,),                32, (1,), (True,  'main',    True,  None), (),            ()),
  ((PRIVKEY_TEST,),           32, (),   (True,  'publictest', False, None), (),           ()),
  ((PRIVKEY_TEST,),           32, (1,), (True,  'publictest', True,  None), (),            ()),
  ((PRIVKEY_SANDBOX,),        32, (),   (True,  'sandbox', False, None), (),            ()),
  ((PRIVKEY_SANDBOX,),        32, (1,), (True,  'sandbox', True,  None), (),            ())
]
# templates for valid bech32 sequences
bech32_templates = [
  # hrp, version, witprog_size, metadata, encoding, output_prefix
  ('hg',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('hg',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('hg',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('hg',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('phg',   0, 20, (False, 'publictest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('phg',   0, 32, (False, 'publictest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('phg',   1, 32, (False, 'publictest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('phg',   3, 16, (False, 'publictest', None, True), Encoding.BECH32M, (OP_3, 16)),
  ('shg',   0, 20, (False, 'sandbox', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('shg',   0, 32, (False, 'sandbox', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('shg',   1, 32, (False, 'sandbox', None, True), Encoding.BECH32M, p2tr_prefix),
  ('shg',  16, 40, (False, 'sandbox', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['hg', 'phg', 'shg', 'bc', 'tb', 'bcrt']:
