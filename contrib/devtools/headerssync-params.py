...
#  not rely on a hardcoded header-hash map. In short it works as follows:
#
...
def find_max_headers(when):
    """Compute the maximum number of headers a valid Quicksilver chain can have at given time."""
