...
This means one can have an always-on quicksilverd instance running, and another local quicksilverd/quicksilver-qt instance which connects to this node and receives blocks from it.
